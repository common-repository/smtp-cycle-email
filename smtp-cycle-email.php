...
function smtp_cp_admin_sidebar() {

	$banners = array(
		array(
			'url' => 'http://www.cybernetikz.com/wordpress-magento-plugins/wordpress-plugins/?utm_source=smtp-cycle-email&utm_medium=banner&utm_campaign=wordpress-plugins',
			'img' => 'banner-1.jpg',
			'alt' => 'Banner 1',
		),
		array(
			'url' => 'http://www.cybernetikz.com/portfolio/web-development/wordpress-website/?utm_source=smtp-cycle-email&utm_medium=banner&utm_campaign=wordpress-plugins',
			'img' => 'banner-2.jpg',
			'alt' => 'Banner 2',
		),
		array(
			'url' => 'http://www.cybernetikz.com/seo-consultancy/?utm_source=smtp-cycle-email&utm_medium=banner&utm_campaign=wordpress-plugins',
			'img' => 'banner-3.jpg',
			'alt' => 'Banner 3',
		),
	);
...
function smtp_cp_admin_style() {
	global $pluginsURI;
	wp_register_style( 'smtp_cp_admin_css', plugins_url( 'smtp-cycle-email/css/admin-style.css' ) , false, '1.0' );
	wp_enqueue_style( 'smtp_cp_admin_css' );
}
add_action( 'admin_enqueue_scripts', 'smtp_cp_admin_style' );
